...
-- Nastaví martin.ficek@iacgroup.com ako admin a pridá ho do prvej company.
-- Po spustení sa používateľ môže odhlásiť a prihlásiť ako martin.ficek@iacgroup.com, alebo obnoviť stránku (F5).
...
where lower(u.email) = lower('martin.ficek@iacgroup.com')
