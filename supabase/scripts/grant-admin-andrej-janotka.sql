-- Spustiť v Supabase Dashboard → SQL Editor (po prihlásení ako existujúci admin).
-- Nastaví andrej.janotka@iacgroup.com ako admin a pridá ho do prvej company.
-- Po spustení sa používateľ môže odhlásiť a prihlásiť ako andrej.janotka@iacgroup.com, alebo obnoviť stránku (F5).
...
where lower(u.email) = lower('andrej.janotka@iacgroup.com')
