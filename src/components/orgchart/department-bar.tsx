              ...
              {allowEdit && (
                <>
                  <button
                    ...
                    title={
                      hasManager
                        ? `${t("orgChart.departmentManager")}: ${getManagerName(managerId)} - ${t("orgChart.changeDepartmentManager")}`
                        : t("orgChart.setDepartmentManager")
                    }
                  ...
                  {openManagerFor === dep &&
                    ...
                    createPortal(
                      <>
                        <div className="fixed inset-0 z-[100]" aria-hidden onClick={closeDropdown} />
                        <div
                          ref={dropdownRef}
                        ...
                        >
                          ...
                          <div className="max-h-48 overflow-y-auto py-1">
                            ...
                            >
                              - Ziadny (nezobrazit oddelenie) -
                            </button>
                            {filteredEmployees.length === 0 ? (
                              <p className="px-3 py-2 text-xs text-slate-500">Ziadne zaznamy</p>
                            ) : (
